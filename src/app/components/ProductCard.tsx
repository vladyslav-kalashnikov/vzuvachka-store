            ...
            <div className="relative z-20 bg-[#111] p-3 sm:p-5">
                ...
                <div className="flex items-end justify-between gap-2 border-t border-white/10 pt-3 sm:gap-3 sm:pt-4">
                    ...
                    <a
                        ...
                        className="group/btn flex h-9 w-9 items-center justify-center rounded-full bg-white text-black transition-all hover:bg-red-600 hover:text-white sm:h-10 sm:w-10"
                    >
